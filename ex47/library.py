...
Red_Dragon_Scenes = [[[0], "The rumbling began beneath your feet. Your eyes traced tremors to the " 
...
"shake its head side to side. Life left you mercifully fast."]
 ...
 Green_Dragon_Scenes = [[[0], "The spruce trees blanket the lowest part of the Eastern snow-capped "
...
Gold_Dragon_Scenes = [[[0], "What could have been the sun itself, lain upon the mountainside, shifted. " 
...
Memory_Nymphs_Scenes = [[[0], "From the mist rising up all around the crashing waterfall a phantasmagoria of "
...
Scorpian_Scenes = [[[0],"The sand shifts slightly, at first it seems a trick of the intense heat "
...
Spewer_Scenes = [[[0], "A sqwauk pierced the air, an unfortunate looking creature entered your "
...
Tile_Change = [[0],"The air grows thick with fog the moment you come to the end of your path. More blind "
"by the moment you become until you can no longer see your hand, lifted in front of your face. The "
"air around you began to dance. Either you were spinning or the whole world spun around you. The fog "
"cleared as quickly as it had gathered. Somehow you are not where you were a moment ago."]

Tree_Disease_Scenes = [[[0], "The aching began in your feet. As if the bones were straining "
...
Twiggins_Scenes = [
           [[0], "A distinctive and offputting sound brought your "
...
Twiggins_Swarm_Scenes = [[[0], "You have stumbled into an active twiggin nest. An upright cylinder, about "
...
"in agony for the unbearable pain that shadows love.\" She exhaled. A sea of though churned behind her "
"eyes. \"Of Love. If that human construct best speeds you on your path whilst you're kept true then I "
"will entertain it. Yet see how you justify violence, conquest in the name of this thing love? Nothing "
"of worth is born else from necessity.\" She crouched down ever so slightly and then was aloft. Her "
"body seemed to melt into the sky. A flash of sunlight off of her tail then she was gone."],
...
"you have survived. Never has an soul risen that had not been forged in the fires of the wilds.\" She "
"launched herself into the sky. She flew over the soul chards and cast a great shadow down upon them. "
"A swoop and she was upon them. A claw wrapped over one shard. She twisted the giant crystalline structure, "
"wrenched it free and carried it up as ice fell from it. She flew over The sorrow, dipped her head the flipped "
"upside down, throwing the crystal high into the air. It spun wildly. She took in a great lung-full of air "
"then unleashed a torrent of flames. Water and ice sprayed out from the crystal in all direction. It shifted, "
"as it spun mid-air, its pieces fell apart at the middle. As the large shards fell away a densely colored mist, "
"the hint of a person, but no more remained. The white Dragon caught this wisp gently on her snout and spirited "
"her down into the gleaming depths of The Sorrow. A moment later, a sound, like a great wave breaking against "
"a cliff face, water rained down upon you and your daughter lie there in front of you. Her eyes two sleepy "
"coins that could buy you all the happiness in the world. You took her in your arms, you warmed her. Your hot "
"tears fell over her face. She hugged you. "]
               ]
##########################################Encounter Dictionary##########################################
encounter = {1: Twiggins_Scenes,
             2: Twiggins_Scenes,
             3: Tile_Change,
             4: Gold_Dragon_Scenes,
             5: The_Sorrow_Scenes,
             6: Dragons_Scenes,
             7: Twiggins_Scenes,
             8: Meadow_Mystic_Scenes,
             9: Twiggins_Swarm_Scenes,
             10: Dragons_Scenes,
...
Hero = {-5: 'punch'}               
##########################################Hitpoints##########################################
Hit_Points = {"Hero": 65, "Red_Dragon": 80, "Green_Dragon": 70, "Gold_Dragon": 65},
"Twiggins": 15, "Twiggins_Swarm": 40, "Scorpian": 15}
Fairy = [30]
Histears = [65] 
Twiggin = [10]
...
White_Dragon_Inp = {'kneel': 1, 'council': 1, 'Great White Dragon': 1, 'stuff': 2, 'stuff': 3, 'stuff': 4}
